...
*/
// FIX: `FunctionCall`, `useUI`, and `useTools` were not exported from `@/lib/state`. They will be added to `@/lib/state` and this import will now work.
import { useSettings, useUI, useTools } from '@/lib/state';
import type { FunctionCall } from '@/lib/state';
          ...
          <div className="sidebar-section">
            <fieldset disabled={connected}>
              ...
              <label>
                ...
                <input
                  type="number"
                  value={responseWindowDuration}
                  onChange={e =>
                    setResponseWindowDuration(Number(e.target.value))
                  }
                  min="1"
                  max="60"
                />
